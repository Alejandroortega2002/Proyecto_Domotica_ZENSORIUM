...
public class RelacionesFB {
    ...
    /**
     * Selecciona un usuario básico de la tabla y actualiza el campo de texto correspondiente.
     */
    @FXML
     ...
     * Crea una relación entre el usuario actual y el usuario básico seleccionado.
     */
    @FXML
